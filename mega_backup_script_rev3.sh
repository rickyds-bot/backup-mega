#!/bin/bash
# =====================================================
# MEGA INCREMENTAL BACKUP - STABLE FIXED VERSION
# Fixed:
# - folder structure preserved
# - safe spaces/unicode handling
# - safer logging
# - better retry handling
# - compatible with MEGAcmd 2.5.x
# =====================================================
...
# BACKUP SCHEDULE
# IMPORTANT:
# NO LEADING SLASH ON DESTINATION
# =====================================================
case $DAY_NUM in
...
incremental_backup() {
    ...
    find "$SRC_DIR" -type f -print0 | while IFS= read -r -d '' FILE; do
        ...
        # CREATE REMOTE DIR
        # =====================================================
        timeout 300 mega-mkdir -p "$REMOTE_TARGET" >> "$LOGFILE" 2>&1
